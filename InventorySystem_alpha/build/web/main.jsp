...
%>
	   ...
	   <%}%>
		...
		<div id="content">
                    <p align="right">
					<a href="LogoutController.jsp"><img src="delete.png" height="35" title="Logout"></img></a>
					</p>
                    <center><img src="checklist2.jpg"></img></center>
		<div><br/></div>
			<div class="post">
				<h1 class="title">Welcome <%=loggedin%>!</h1>
				<p class="byline"><small><%= new java.util.Date() %></small</p>
				<div class="entry">
					<p>All the functionalities that you need are provided in this main page. Feel free to contact us
					if you have comments or suggestions.Thank you.</p>
