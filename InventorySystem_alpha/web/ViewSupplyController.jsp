...
<%
    String supplyname;
    supplyname = request.getParameter("supply_name");

    inventorysystem.dao.Supply supply = (inventorysystem.dao.Supply)inventorysystem.dao.SupplyPeer.retrieveSupply(supplyname);
    int supply_amt = supply.returnSupplyQuantity();
    String type = supply.getType();
    String source = supply.getSource();
    String location = supply.getLocation();
				...
				<li>
					...
					<%
						...
						for(int i=0; i<supplies2.size(); i++)
						{
							...
							String supply2 = supplyList.returnSupplyName();
                                         %>
