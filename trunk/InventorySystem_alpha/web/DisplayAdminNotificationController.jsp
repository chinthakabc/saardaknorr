...
<%
  java.util.List toBeApproved = inventorysystem.dao.UserPeer.retrieveInactiveUsers();

  if (toBeApproved.isEmpty()){
%>
<h5>no account requests</h5>
...
<%}
      ...
      <table>
          <tr><td>
                  <h5>  <%out.println(toBeApproved.size()); %> accounts waiting to be approved</h5>
              </td></tr>
      </table>
     <br />
      <%}
