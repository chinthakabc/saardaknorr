       ...
       %>
				...
				<li>
					...
					<ul>
						...
						<li><a href="ApparatusInventoryView.jsp">Laboratory Equipment</a></li>
...
<%
 ...
 {
     supplies = inventorysystem.dao.Supply_GenChemPeer.retrieveSuppliesByType("equipment");
 }
 else if(request.getParameter("division").equals("_BioChem"))
 {
     supplies = inventorysystem.dao.Supply_BioChemPeer.retrieveSuppliesByType("equipment");
 }
 else if(request.getParameter("division").equals("_PhyChem"))
 {
     supplies = inventorysystem.dao.Supply_PhyChemPeer.retrieveSuppliesByType("equipment");
 }
 else if(request.getParameter("division").equals("_AnaChem"))
 {
     supplies = inventorysystem.dao.Supply_AnaChemPeer.retrieveSuppliesByType("equipment");
 }
 else if(request.getParameter("division").equals("_OrgChem"))
 {
     supplies = inventorysystem.dao.Supply_OrgChemPeer.retrieveSuppliesByType("equipment");
 }

                if (supplies.isEmpty())
                {
                    %>
                    <form method="post" action="EquipmentInventoryView2.jsp">
    <h3>Division:</h3>
    ...
    <center>
                    <h2>There are no more equipment in stock.</h2>
    <center>
                    <%
                }
                else
