 ...
 *
 */
public abstract class BaseSystem_LogPeer
    extends BasePeer
{
    ...
    {
        return getMapBuilder(System_LogMapBuilder.CLASS_NAME);
    }
    ...
    public static final String LOCATION;
      /** the column name for the PREVIOUS_VALUE field */
    public static final String PREVIOUS_VALUE;
      /** the column name for the CURRENT_VALUE field */
    ...
    protected static final String CLASSNAME_DEFAULT =
        "inventorysystem.dao.System_Log";
    ...
    public static void addSelectColumns(Criteria criteria)
            throws TorqueException
    {
          criteria.addSelectColumn(LOG_ID);
          criteria.addSelectColumn(USER_ID);
          criteria.addSelectColumn(ACTION);
          criteria.addSelectColumn(LOCATION);
          criteria.addSelectColumn(PREVIOUS_VALUE);
          criteria.addSelectColumn(CURRENT_VALUE);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static System_Log row2Object(Record row,
                                             int offset,
                                             Class cls)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        ...
        for (int i = 0; i < records.size(); i++)
        {
            Record row = (Record) records.get(i);
              results.add(System_LogPeer.row2Object(row, 1,
                System_LogPeer.getOMClass()));
          }
        return results;
    }
        ...
        throws TorqueException
    {
        Criteria selectCriteria = new Criteria(DATABASE_NAME, 2);
                   selectCriteria.put(LOG_ID, criteria.remove(LOG_ID));
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List doSelect(System_Log obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(System_Log obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(System_Log obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(System_Log obj) throws TorqueException
    {
    ...
    /**
     * Method to do inserts.  This method is to be used during a transaction,
     * otherwise use the doInsert(System_Log) method.  It will take
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doInsert(System_Log obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doUpdate(System_Log) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to update in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doUpdate(System_Log obj, Connection con)
        throws TorqueException
    {
     ...
     * otherwise use the doDelete(System_Log) method.  It will take
     * care of the connection details internally.
     *
     * @param obj the data object to delete in the database.
     * @param con the connection to use
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static void doDelete(System_Log obj, Connection con)
        throws TorqueException
    {
    ...
    public static Criteria buildCriteria( System_Log obj )
    {
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                criteria.add(LOG_ID, obj.getLog_ID());
     ...
     */
    public static System_Log retrieveByPK(int pk)
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static System_Log retrieveByPK(ObjectKey pk)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        Connection db = null;
        System_Log retVal = null;
        try
        {
     ...
     * @throws TooManyRowsException Primary key was not found in database.
     */
    public static System_Log retrieveByPK(ObjectKey pk, Connection con)
        throws TorqueException, NoRowsException, TooManyRowsException
    {
    ...
    /**
     * selects a collection of System_Log objects pre-filled with their
     * User objects.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in System_LogPeer.
     *
     * @throws TorqueException Any exceptions caught during processing will be
     *         rethrown wrapped into a TorqueException.
     */
        ...
        throws TorqueException
    {
        ...
        UserPeer.addSelectColumns(c);
                        ...
                        c.addJoin(System_LogPeer.USER_ID,
            UserPeer.USER_ID);
        ...
        for (int i = 0; i < rows.size(); i++)
        {
            Record row = (Record) rows.get(i);
                    ...
                    System_Log obj1 = (System_Log) System_LogPeer
