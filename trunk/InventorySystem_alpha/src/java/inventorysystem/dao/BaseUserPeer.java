    ...
    extends BasePeer
{
    ...
    public static final String EMPLOYEENUMBER;
    ...
    public static final String PASSWORD;
      /** the column name for the CONTACTNUMBER field */
        ...
        throws TorqueException
    {
        ...
        {
            Object possibleBoolean = criteria.get(STATE);
            if (possibleBoolean instanceof Boolean)
            {
                if (((Boolean) possibleBoolean).booleanValue())
                {
                    criteria.add(STATE, 1);
                }
                else
                {
                    criteria.add(STATE, 0);
                }
            }
         }
            ...
            throws TorqueException
    {
          ...
          criteria.addSelectColumn(EMPLOYEENUMBER);
          ...
          criteria.addSelectColumn(CONTACTNUMBER);
        ...
        throws TorqueException
    {
        try
        {
                obj.setUser_ID(row.getValue(offset + 0).asInt());
                  obj.setEmployeeNumber(row.getValue(offset + 1).asString());
                  ...
                  obj.setUserName(row.getValue(offset + 5).asString());
                  obj.setPassword(row.getValue(offset + 6).asString());
                  obj.setContactNumber(row.getValue(offset + 7).asString());
                  obj.setDivision(row.getValue(offset + 8).asString());
                  obj.setType(row.getValue(offset + 9).asString());
                  obj.setStatus(row.getValue(offset + 10).asBoolean());
                  obj.setState(row.getValue(offset + 11).asBoolean());
              }
        catch (DataSetException e)
        {
            throw new TorqueException(e);
        ...
        throws TorqueException
    {
        Criteria selectCriteria = new Criteria(DATABASE_NAME, 2);
                   selectCriteria.put(USER_ID, criteria.remove(USER_ID));
                                                                                   selectCriteria.put(CONTACTNUMBER, criteria.remove(CONTACTNUMBER));
                                      // check for conversion from boolean to int
        if (criteria.containsKey(STATUS))
        {
            Object possibleBoolean = criteria.get(STATUS);
        ...
        Criteria criteria = new Criteria();
          SimpleKey[] keys = (SimpleKey[])pk.getValue();
                    criteria.add(USER_ID, keys[0]);
                      criteria.add(CONTACTNUMBER, keys[1]);
                    return criteria;
     }
        ...
        Criteria criteria = new Criteria(DATABASE_NAME);
              if (!obj.isNew())
                criteria.add(USER_ID, obj.getUser_ID());
                  criteria.add(EMPLOYEENUMBER, obj.getEmployeeNumber());
              ...
              if (!obj.isNew())
                criteria.add(CONTACTNUMBER, obj.getContactNumber());
        ...
        else
        {
            ...
            while (iter.hasNext())
            {
                ...
                SimpleKey[] keys = (SimpleKey[])pk.getValue();
                        ...
                        CONTACTNUMBER, keys[1], Criteria.EQUAL);
                                    c0.and(c1);
                          criteria.or(c0);
            }
     ...
     *
       ...
       */
    public static User retrieveByPK(
       int user_id
             ...
             ,Connection con) throws TorqueException
    {
        ...
        Criteria criteria = new Criteria(5);
          ...
          criteria.add(CONTACTNUMBER, contactnumber);
          List v = doSelect(criteria, con);
        if (v.size() != 1)
        {
