...
public abstract class BaseUser extends BaseObject
{
    ...
    public void setUser_ID(int v) throws TorqueException
    {
        ...
        // update associated System_Log
        if (collSystem_Logs != null)
        {
            for (int i = 0; i < collSystem_Logs.size(); i++)
            {
                ((System_Log) collSystem_Logs.get(i))
                    .setUser_ID(v);
            }
        }
                      }
    ...
    /**
     * Collection to store aggregation of collSystem_Logs
     */
    protected List collSystem_Logs;

    /**
     * Temporary storage of collSystem_Logs to save a possible db hit in
     * the event objects are add to the collection, but the
     * complete collection is never requested.
     */
    protected void initSystem_Logs()
    {
        if (collSystem_Logs == null)
        {
            collSystem_Logs = new ArrayList();
        }
    }

    /**
     * Method called to associate a System_Log object to this object
     * through the System_Log foreign key attribute
     *
     * @param l System_Log
     * @throws TorqueException
     */
    public void addSystem_Log(System_Log l) throws TorqueException
    {
        getSystem_Logs().add(l);
        l.setUser((User) this);
    }

    /**
     * The criteria used to select the current contents of collSystem_Logs
     */
    private Criteria lastSystem_LogsCriteria = null;

    /**
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getSystem_Logs(new Criteria())
     *
     * @throws TorqueException
     */
    public List getSystem_Logs() throws TorqueException
    {
        if (collSystem_Logs == null)
        {
            collSystem_Logs = getSystem_Logs(new Criteria(10));
        }
        return collSystem_Logs;
    }
     ...
     * an identical criteria, it returns the collection.
     * Otherwise if this User has previously
     * been saved, it will retrieve related System_Logs from storage.
     * If this User is new, it will return
     * an empty collection or the current collection, the criteria
     * is ignored on a new object.
     *
     * @throws TorqueException
     */
    public List getSystem_Logs(Criteria criteria) throws TorqueException
    {
        if (collSystem_Logs == null)
        {
            if (isNew())
            ...
            {
                      criteria.add(System_LogPeer.USER_ID, getUser_ID() );
                      collSystem_Logs = System_LogPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                // one, just return the collection.
                      criteria.add(System_LogPeer.USER_ID, getUser_ID());
                      if (!lastSystem_LogsCriteria.equals(criteria))
                {
                    collSystem_Logs = System_LogPeer.doSelect(criteria);
                }
            }
        }
        lastSystem_LogsCriteria = criteria;
     ...
     * If this collection has already been initialized, returns
     * the collection. Otherwise returns the results of
     * getSystem_Logs(new Criteria(),Connection)
     * This method takes in the Connection also as input so that
     * referenced objects can also be obtained using a Connection
     * that is taken as input
     */
    public List getSystem_Logs(Connection con) throws TorqueException
    {
        if (collSystem_Logs == null)
        {
            collSystem_Logs = getSystem_Logs(new Criteria(10), con);
        }
        return collSystem_Logs;
    }
     ...
     * that is taken as input
     */
    public List getSystem_Logs(Criteria criteria, Connection con)
            throws TorqueException
    {
        if (collSystem_Logs == null)
        {
            ...
            {
                       criteria.add(System_LogPeer.USER_ID, getUser_ID());
                       collSystem_Logs = System_LogPeer.doSelect(criteria, con);
             }
         }
         else
         {
     ...
     * actually need in User.
     */
    protected List getSystem_LogsJoinUser(Criteria criteria)
        throws TorqueException
    {
        if (collSystem_Logs == null)
        {
            ...
            {
                            criteria.add(System_LogPeer.USER_ID, getUser_ID());
                            collSystem_Logs = System_LogPeer.doSelectJoinUser(criteria);
            }
        }
        else
        {
    ...
    public void save(Connection con) throws TorqueException
    {
          if (!alreadyInSave)
        {
            ...
            if (collSystem_Logs != null)
            {
                for (int i = 0; i < collSystem_Logs.size(); i++)
                {
                    ((System_Log) collSystem_Logs.get(i)).save(con);
                }
            }
                          alreadyInSave = false;
        }
    ...
    protected User copyInto(User copyObj) throws TorqueException
    {
        ...
        for (int i = 0; i < v.size(); i++)
        {
            System_Log obj = (System_Log) v.get(i);
            copyObj.addSystem_Log(obj.copy());
        }
