...
<%
 ...
 {
     supplies = inventorysystem.dao.Supply_GenChemPeer.retrieveSuppliesByType("reagent");
 }
 else if(request.getParameter("division").equals("_BioChem"))
 {
     supplies = inventorysystem.dao.Supply_BioChemPeer.retrieveSuppliesByType("reagent");
 }
 else if(request.getParameter("division").equals("_PhyChem"))
 {
     supplies = inventorysystem.dao.Supply_PhyChemPeer.retrieveSuppliesByType("reagent");
 }
 else if(request.getParameter("division").equals("_AnaChem"))
 {
     supplies = inventorysystem.dao.Supply_AnaChemPeer.retrieveSuppliesByType("reagent");
 }
 else if(request.getParameter("division").equals("_OrgChem"))
 {
     supplies = inventorysystem.dao.Supply_OrgChemPeer.retrieveSuppliesByType("reagent");
 }

                if (supplies.isEmpty())
                {
                    %>
                    <form method="post" action="ReagentsInventoryView2.jsp">
    <h3>Division:</h3>
    ...
    <center>
                    <h2>There are no more reagents in stock.</h2>
    <center>
                    <%
                }
                else
