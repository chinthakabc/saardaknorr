...
<br/>
<form method="post" action="IssueORFView2.jsp">
    <table>
        <tr><td>
        Supply Name:</td><td><input type="text" name="sname"/>
        </td></tr>
        <tr><td>
        Supply Type:</td><td<select name="supplytype" class="pretext2" id = "input2">
                    <option value="novalue">[select one]</option>
                    <option value="reagent">Reagent</option>
                    <option value="apparatus">Apparatus</option></select>
        </td></tr>
        <tr><td>
        Quantity:</td><td><input type="text" name="quantity"/>
        </td></tr>
        <tr><td>
        Amount Price per Unit:</td><td><input type="text" name="price"/>
        </td></tr>
    </table>
    <br/>
