...
<form method="post" action="EditSupplyView3.jsp">
    <table>
        ...
        <tr><td>Source:</td><td><input type="text" name="source" value="<%=supplyEdit.getSource()%>" /></td></tr>
        <tr><td>Location:</td><td><input type="text" name="location" value="<%=supplyEdit.getLocation()%>" /></td></tr>
    <br/>
    </table>
